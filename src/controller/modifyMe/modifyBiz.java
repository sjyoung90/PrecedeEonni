...
/**
 * Servlet implementation class modifyBiz
 */
public class modifyBiz extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String updateBiz = "UPDATE	business " +
				"SET company='"+company+"', kind='"+kind+"', position='"+position+"' WHERE biz_st="+id+";";
		
		//ServletContext sc = getServletContext();
		conn c = new conn();
		Connection updateConn= c.getConn();
		System.out.println("modifyBiz");
		...
		if(resultToJSP == 3)	System.out.println("modifyBiz 수정 성공");
		else	System.out.println("modifyBiz 수정 실패");
