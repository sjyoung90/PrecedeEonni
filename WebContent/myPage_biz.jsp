...
String	bizSt = "SELECT	* FROM business WHERE biz_st="+id+";";
        ...
        function setMajor() {
            ...
            with (document.mentor_join) {
                if (college.value == "0") {
                    ...
                    valArray = new Array("수학과", "통계학과", "생명과학·화학부", "IT학부");
                    makeOptions(valArray);
                }
...
<body onload="setMajor();">
   ...
   <div class="slide">
	<div class="form">
    <form action="modifyEN_b" method="post" name="mentor_join" enctype="multipart/form-data"  onSubmit= "return valid();">
    ...
    <tr>
        ...
        <tr>
            <th id="td7" class="current"> 회사명 </th>
            <td><input type="text" id="company" name="company" value="<%=company %>"/></td>
            <th id="td8" class="current"> 창업분야 </th>
            <td><input type="text" id="kind" name="kind" value="<%=kind %>"/></td>
